...
public class RESTAPIMapping {
    public static final String ALLOCATION_CONTROLLER = "allocations";
    public static final String COHORT_CONTROLLER = "cohorts";
    public static final String PROGRAM_CONTROLLER = "programs";
    public static final String COHORT_MEMBER_CONTROLLER = "cohort-members";
    public static final String COHORT_MEMBER_CATEGORY_CONTROLLER = "cohort-member-categories";
    public static final String ELIGIBILITY_CRITERIA_CONTROLLER = "eligibility-criteria";
